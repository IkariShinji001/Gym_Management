...
export class FacilitiesController {
  ...
  @Post()
  async create(@Body() createFacilityDto: CreateFacilityDto): Promise<Facilities> {
    return await this.facilitiesService.create(createFacilityDto);
  }
  @Patch(':id')
  async update(@Param('id') id: number,@Body() updateFacility: updateFacilityDto): Promise<Facilities> {
